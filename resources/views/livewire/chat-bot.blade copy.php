<div class="chatbot-box relative w-full">
    <!-- component -->
    <div class="chatbot-btn-container fixed bottom-0 right-0 z-30 cursor-pointer border-gray-500 shadow">
    ...
    <div class="chatbot-window flex-1 p-2 sm:p-6 justify-between flex flex-col h-screen border border-solid border-blue-500 fixed {{ $winPosition=="left"?"left-0":"right-0" }} bottom-0 bg-white shadow z-30 {{ $panelHidden ? 'hidden' : '' }}" style="{{ $winWidth }}" id="chat-window">
        <div class="chatbot-window-header flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
            <div class="chatbot-avatar relative flex items-center space-x-4">
                <div class="relative">
            ...
            <div class="chatbot-window-actions flex items-center space-x-2">
                <button type="button" class="chatbot-window-action-button inline-flex items-center justify-center rounded-lg border h-8 w-8 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none" wire:click="resetSession()" title="clear text [CTRL+D]">
        ...
        <div id="messages" class="chatbot-content-box flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch">
                    ...
                    <div class="chat-message">
                        <div class="flex items-end">
                            <div class="flex flex-col space-y-2 text-xs mx-2 order-2 items-start">
                                <div><div class="message-content px-4 py-2 rounded-lg block rounded-bl-none bg-gray-300 text-gray-600">@isset($message['content']){!! \Illuminate\Mail\Markdown::parse($message['content']) !!}@endisset</div></div>
                            </div>
                    ...
                    <div class="chat-message">
                        <div class="flex items-end justify-end">
                            <div class="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-1 items-end">
                                <div><div class="message-content px-4 py-2 rounded-lg block rounded-br-none bg-blue-600 text-white">{!! \Illuminate\Mail\Markdown::parse($message['content']) !!}</div></div>
                            </div>
                            @php
        ...
        <div class="chatbot-input-box border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
            <div class="message-tip py-2 text-sm" style="color:rgb(35, 190, 100)" wire:loading wire:target="sendMessage">Message Sending...</div>
            <div class="chatbot-input-wrapper flex flex-col w-full py-2 flex-grow md:py-3 md:pl-4 relative bg-gray-200 dark:border-gray-900/50 dark:text-white dark:bg-gray-700 rounded-md shadow">
